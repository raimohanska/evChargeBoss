...
- [ ] See if it's possible to get the actual charging power of the charger by running it ON for 15 seconds when power is detected. This should allow us to remove the configuration setting for power.
